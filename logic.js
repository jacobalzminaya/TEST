...
function updateSuggestionPanel() {
  ...
  // Mostrar descripción directamente — ya no necesita el número entre paréntesis
  // porque el nombre (MEDIA+, FUERTE, etc.) ya lo dice. La descripción da contexto
  // sobre qué tipo de vela corresponde a esa fuerza.
